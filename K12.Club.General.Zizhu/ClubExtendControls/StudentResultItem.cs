...
{
    [FISCA.Permission.FeatureCode("K12.Club.Universal.StudentResultItem.cs", "拓展性课程成绩")]
    public partial class StudentResultItem : DetailContentBase
    {
        ...
        void BGW_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                this.Loading = false;
                FISCA.Presentation.Controls.MsgBox.Show("取得成绩发生错误!!\n" + e.Error.Message);
